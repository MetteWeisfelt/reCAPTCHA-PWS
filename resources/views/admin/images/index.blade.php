        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('admin.image.index') }}">Images<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
@section('content')
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                <div class="clear-fix">
                    <h2 class="d-inline-block align-middle">Images</h2>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnImageDelete', function () {
            if (confirm("Are you sure you want to delete this item?")) {
                $.ajax({
                    type: "POST",
                    url: "{{ url('/admin/image') }}" + "/" + lastClickedImageId,
                    data: {
                        _token: '{{csrf_token()}}',
                        _method: 'DELETE'
                    },
